...
**YOU ARE IN: `musicedit/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/musicedit/` (rig root) or other directories
...
**Your mail address:** `musicedit/polecats/rust`
**Your rig:** musicedit
**Your Witness:** `musicedit/witness`
...
| Ask Witness for help | `gt mail send musicedit/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`musicedit/witness`) when:
...
```bash
gt mail send musicedit/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
